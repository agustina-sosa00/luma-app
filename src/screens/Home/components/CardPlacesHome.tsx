...
export default function CardPlaceHome({ place }: any) {
  return (
    <View className="z-50 flex h-52 w-72 items-center">
      <View className="flex h-full  w-full items-center justify-between rounded-lg bg-onPrimary pb-2">
        <Image
          source={{
